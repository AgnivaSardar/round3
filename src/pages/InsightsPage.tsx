              ...
              <ResponsiveContainer width="100%" height={280}>
                <BarChart data={insightsData.commonFaults} layout="vertical" margin={{ left: 20 }}>
                  ...
                  <Tooltip
                    ...
                    contentStyle={{ background: 'hsl(220, 43%, 99%)', border: '1px solid hsl(220, 13%, 18%)', borderRadius: 8, fontSize: 12 }}
            ...
            {insightsData.severityBreakdown.length > 0 && insightsData.severityBreakdown.some(s => s.value > 0) ? (
              <ResponsiveContainer width="100%" height={280}>
                <PieChart>
                  ...
                  <Tooltip
                    wrapperStyle={{ zIndex: 1000 }}
                    contentStyle={{ background: 'hsl(223, 47%, 97%)', border: '1px solid hsl(220, 13%, 18%)', borderRadius: 8, fontSize: 12 }}
                    labelStyle={{ color: 'hsl(215, 15%, 55%)' }}
                    itemStyle={{ color: 'hsl(215, 15%, 55%)' }}
                  />
                </PieChart>
            ...
            {insightsData.topAlertVehicles.length > 0 ? (
              <ResponsiveContainer width="100%" height={240}>
                <BarChart data={insightsData.topAlertVehicles}>
                  ...
                  <Tooltip
                    wrapperStyle={{ zIndex: 1000 }}
                    contentStyle={{ background: 'hsl(180, 14%, 99%)', border: '1px solid hsl(220, 13%, 18%)', borderRadius: 8, fontSize: 12 }}
                    labelStyle={{ color: 'hsl(215, 15%, 55%)' }}
                    itemStyle={{ color: 'hsl(215, 15%, 55%)' }}
                  />
